# HDI_4DVP_allow_formulas

How do I create custom functions in [4D View Pro](https://us.4d.com/4d-view-pro)? (4D v18 R5)

Find more information on the [blog post](https://blog.4d.com/4d-view-pro-use-4d-formulas-in-your-spreadsheet/).
